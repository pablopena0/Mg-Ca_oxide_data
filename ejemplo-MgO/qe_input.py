...
#Parámetros
simetria=3      #1 si no tiene, 2 si tiene 2 ejes iguales, 3 si tiene los 3 ejes iguales
elemento="MgO"
main_folder="./"
...
for n in range(1):
    ...
    f_p1=open(main_folder+"plantillas/plantillaQE_1.txt","r")
    f_p2=open(main_folder+"plantillas/plantillaQE_2.txt","r")
    f_c1=open(main_folder+"plantillas/colas_1.txt","r")
    f_c2=open(main_folder+"plantillas/colas_2.txt","r")
    ...
    f_out.write("CELL_PARAMETERS {angstrom}\n")
...
for n in range(-100,110,25):
    ...
    f_p1=open(main_folder+"plantillas/plantillaQE_1_hydro.txt","r")
    f_p2=open(main_folder+"plantillas/plantillaQE_2_hydro.txt","r")
    f_p3=open(main_folder+"plantillas/plantillaQE_3_hydro.txt","r")
    f_c1=open(main_folder+"plantillas/colas_1.txt","r")
    f_c2=open(main_folder+"plantillas/colas_2.txt","r")
    f_poss=open(main_folder+"posiciones.txt","r")
    f_base=open(main_folder+"base.txt","r")
